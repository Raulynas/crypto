...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light text-white shadow-sm">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ route('stock.index') }}">
                    The Crypto Stock
                </a>
                    ...
                    <ul class="navbar-nav ml-auto text-white">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right text-white" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item text-white" href="{{ route('stock.index') }}">Home</a>
                                <a class="dropdown-item text-white" href="{{ route('stock.create') }}">Add asset</a>
                                <a class="dropdown-item text-white" href="{{ route('stock.prices') }}">Prices</a>
                            </div>
                        </li>
